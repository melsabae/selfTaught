...
Test(Test_RC, Test_RC_Failure)
{
    ...
    cr_assert(std::get<1>(ret).size() == 1);
    ...
    cr_assert(std::get<1>(ret).size() == 1);
    cr_assert(std::get<1>(ret)[0] == "todo");
    cr_assert(std::get<1>(ret)[0] != "");
}
...
Test(Test_RC, Test_RC_Chaining)
{
    ...
    cr_assert(std::get<1>(ret).size() == 3);

    // the rc uses a stack for error messages
    cr_assert(std::get<1>(ret)[0] == "todo2");
    cr_assert(std::get<1>(ret)[1] == "todo");
    cr_assert(std::get<1>(ret)[2] == "");
}
